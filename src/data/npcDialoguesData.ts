...
export const studentDialogueEvents: DialogueEvent[] = Array.from({ length: 150 }, (_, index) => {
  ...
  const themes = [
    {
      ...
      effects4: [{ stat: 'studentTrust', value: 10 }, { stat: 'studentTrust', value: 4 }, { stat: 'burnout', value: 2 }],
    ...
    },
    {
      ...
      effects4: [{ stat: 'studentTrust', value: 12 }, { stat: 'studentTrust', value: 6 }, { stat: 'adminPower', value: -2 }],
    ...
    },
    {
      ...
      effects4: [{ stat: 'studentTrust', value: 10 }, { stat: 'studentTrust', value: 4 }, { stat: 'adminPower', value: -2 }],
  ...
  const defaultTheme = {
    ...
    effects4: [{ stat: 'studentTrust', value: 8 }, { stat: 'studentTrust', value: 4 }, { stat: 'adminPower', value: -2 }],
