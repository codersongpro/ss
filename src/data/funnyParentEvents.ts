...
export const funnyParentEvents: GameEvent[] = [
    ...
    choices: [
      {
        ...
        immediateEffects: [
          { stat: 'studentTrust', value: 13 },
          { stat: 'expert', value: 11 },
          { stat: 'hp', value: -5 }
        ],
  ...
  },
  {
    ...
    category: 'parent',
    situation: '교문',
    narratorText: '아침 교문 앞 등교 지도 시간, 번쩍이는 롤스로이스 한 대가 교문 횡단보도를 가로막고 섰습니다. 차 안에서 클럽용 데시벨 높은 힙합 음악이 교정에 울려 퍼지고, 동우 아버님이 금목걸이를 하시고 내리더니 "동우야! 오늘도 기 팍 펴고 학교 찢어라!"라며 춤을 추듯 하이파이브를 하십니다. 아이들이 구경하느라 북새통을 이룹니다. 어떻게 수습하시겠습니까?',
    weight: 100,
  ...
  },
  {
    ...
    category: 'parent',
    situation: '교실 뒷자리',
    narratorText: '교실 청소 시간 중 웅이의 가방에 달린 귀여운 곰인형 뱃지의 눈 부분이 미세하게 반짝이는 것을 발견했습니다. 확인해 보니 소형 녹음 칩이 내장된 기기였습니다! 웅이 어머님께 전화를 걸자 "어머 선생님, 도청이라니요! 웅이가 학교에서 소외당하거나 담임 선생님이 무섭게 하진 않는지 정서적 안정을 위해 달아준 소리 모니터 뱃지일 뿐입니다!"라며 억울함을 외치십니다. 어떻게 대응하시겠습니까?',
    weight: 100,
