...
export const funnyRandomEvents: GameEvent[] = [
  ...
  },
  {
    ...
    narratorText: '격렬했던 4교시 수업과 급식 지도를 마치고 퇴근하기 위해 자리에 일어섰습니다. 짐을 싸다가 내 바지 앞 지퍼를 우연히 내려다보았는데, 바지 남성용 지퍼가 반쯤 개방되어 대나무 구멍이 열려 있는 미스터리한 실태를 발견했습니다! 오늘 4교시 동안 몇 명의 아이들과 지퍼 조우(?)를 나눴는지 아찔해집니다. 어떻게 하시겠습니까?',
    weight: 100,
